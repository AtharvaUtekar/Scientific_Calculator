...
pi_btn = Button(btnrow1, text="π", font="Helvetica 18", relief=GROOVE, bd=0, command=pi_clicked, fg="white", bg="#aee1e1")
pi_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)

fact_btn = Button(btnrow1, text=" x! ", font="Helvetica 18", relief=GROOVE, bd=0, command=fact_clicked, fg="white", bg="#aee1e1")
fact_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)

sin_btn = Button(btnrow1, text="sin", font="Helvetica 18", relief=GROOVE, bd=0, command=sin_clicked, fg="white", bg="#aee1e1")
sin_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)

cos_btn = Button(btnrow1, text="cos", font="Helvetica 18", relief=GROOVE, bd=0, command=cos_clicked, fg="white", bg="#aee1e1")
cos_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)

tan_btn = Button(btnrow1, text="tan", font="Helvetica 18", relief=GROOVE, bd=0, command=tan_clicked, fg="white", bg="#aee1e1")
tan_btn.pack(side=LEFT, expand=TRUE, fill=BOTH)

btn1 = Button(btnrow1, text="1", font="Helvetica 23", relief=GROOVE, bd=0, command=btn1_clicked, fg="white", bg="#aee1e1")
btn1.pack(side=LEFT, expand=TRUE, fill=BOTH)

btn2 = Button(btnrow1, text="2", font="Helvetica 23", relief=GROOVE, bd=0,  command=btn2_clicked, fg="white", bg="#aee1e1")
btn2.pack(side=LEFT, expand=TRUE, fill=BOTH)

btn3 = Button(btnrow1, text="3", font="Helvetica 23", relief=GROOVE, bd=0, command=btn3_clicked, fg="white", bg="#aee1e1")
btn3.pack(side=LEFT, expand=TRUE, fill=BOTH)

btnp = Button(btnrow1, text="+", font="Helvetica 23", relief=GROOVE, bd=0, command=btnp_clicked, fg="white", bg="#aee1e1")
...
conv_btn = Button(btnrow3, text="Rad", font="Helvetica 12 bold", relief=GROOVE, bd=0, command=conv_clicked, fg="white", bg="#276678")
...
del_btn = Button(btnrow4, text="⌫", font="Helvetica 20", relief=GROOVE, bd=0, command=del_clicked, fg="white", bg="#03506f")
